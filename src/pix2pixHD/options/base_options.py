...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--niter_fix_global', type=int, default=0, help='number of epochs that we only train2 the outmost local enhancer')        
    ...
    def parse(self, save=True):
        ...
        self.opt.isTrain = self.isTrain   # train2 or test
